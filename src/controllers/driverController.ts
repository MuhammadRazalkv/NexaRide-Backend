...
class DriverController implements IDriverController {
    ...
    async addInfo(req: Request, res: Response): Promise<void> {
        try {
            ...
            res.status(201).json({ message: 'Driver information has been successfully added', driverId: response.driverId })
    ...
    async addVehicle(req: Request, res: Response): Promise<void> {
        try {
            ...
            res.status(201).json({ message: 'Vehicle information has been successfully added', driver: response.driver })
    ...
    async reApplyDriver(req: ExtendedRequest, res: Response): Promise<void> {
        try {
            ...
            res.status(201).json({ message: 'Driver information has been successfully submitted for reverification', driver: response.updatedData })
    ...
    async vehicleRejectReason(req: ExtendedRequest, res: Response): Promise<void> {
        try {
            if (!req.id) {
                throw new Error('Id not found')
            }
    ...
    async reApplyVehicle(req: ExtendedRequest, res: Response): Promise<void> {
        try {
            ...
            const response = await vehicleService.reApplyVehicle(req.id, req.body.data)
            console.log('response ', response);
