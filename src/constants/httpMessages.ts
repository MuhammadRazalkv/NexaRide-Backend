export const messages = {
  ...
  ACCOUNT_BLOCKED:
    "Your account has been blocked. Please reach out to support for assistance.",
  ...
  DRIVER_NOT_REJECTED:
    "There’s an issue with your application status. Please log in to check it.",
  SUBMITTED_FOR_REVERIFICATION:
    "Your information has been submitted for re-verification.",

  // Payment & Wallet
  INSUFFICIENT_BALANCE: "Your wallet does not have enough balance.",
  PAYMENT_FAILED: "Payment could not be processed. Please try again.",
  INVALID_TRANSACTION:
    "Invalid transaction details. Please check and try again.",
  ...
  // Ride Booking
  NO_AVAILABLE_RIDES:
    "No rides are currently available. Please try again later.",
  OTP_VERIFICATION_FAILED:
    "OTP verification was unsuccessful. Please check the code and try again.",
