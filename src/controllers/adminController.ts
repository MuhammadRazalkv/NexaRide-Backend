...
class AdminController {
    ...
    async getPendingDriversWithVehicle(req: Request, res: Response): Promise<void> {
        try {
    ...
    async rejectDriver(req: Request, res: Response): Promise<void> {
        try {
            const result = await adminService.rejectDriver(req.body.driverId,req.body.reason)
    ...
    async rejectVehicle(req: Request, res: Response): Promise<void> {
        try {
            const result = await adminService.rejectVehicle(req.body.vehicleId, req.body.reason);
