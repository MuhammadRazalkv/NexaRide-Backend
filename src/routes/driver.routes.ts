...
driverRoutes.post(
  ...
  driverController.requestPasswordReset
);
...
driverRoutes.get(
  "/vehicleRejectReason",
  authMiddleware,
  driverController.vehicleRejectReason
);
driverRoutes.patch(
  "/reApplyVehicle",
  authMiddleware,
...
driverRoutes.get(
  "/getDriverInfo",
  authMiddleware,
  driverController.getDriverInfo
);
driverRoutes.patch(
  "/updateDriverInfo",
  authMiddleware,
...
driverRoutes.patch(
  "/updateProfilePic",
  authMiddleware,
  driverController.updateProfilePic
);
driverRoutes.patch(
  "/updateAvailability",
  authMiddleware,
...
driverRoutes.post(
  "/useRandomLocation",
  authMiddleware,
  rideController.assignRandomLocation
);
driverRoutes.post(
  "/verifyRideOTP",
  authMiddleware,
